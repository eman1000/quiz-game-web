...
const PickOpponent = props => {
  ...
  const {
    data: { loading, error, getCategory },
    match,
    user
  } = props;
        ...
        <div className={"modal"}>
          ...
          <div className={"search-container"}>
            <input type="search" className={"input"} />
              ...
              <button className="btn outline disabled multiplayer-btn">
                Multiplayer
...
export default graphql<IGetCategotyProps, GetCategoryVariables, {}>(
  GET_CATEGORY,
  {
    options: props => ({
